variable "tenant_id" {
  description = "Azure tenant containing the dev resources."
  type        = string
...
variable "subscription_id" {
  description = "Azure subscription containing the dev resources."
  type        = string
...
variable "bootstrap_serial" {
  description = "Three-digit suffix matching the bootstrap-owned dev resource group."
  type        = string
...
variable "repository" {
  description = "Repository responsible for the dev resources."
  type        = string
