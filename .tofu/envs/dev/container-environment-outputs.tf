output "container_app_environment_id" {
  description = "Resource ID of the isolated dev Container Apps managed environment."
  value       = module.container_environment.environment_id
}

output "container_app_environment_name" {
  description = "Name of the isolated dev Container Apps managed environment."
  value       = module.container_environment.environment_name
}

output "container_app_environment_default_domain" {
  description = "Default domain of the dev managed environment."
  value       = module.container_environment.default_domain
}

output "container_app_environment_static_ip_address" {
  description = "Static address of the dev managed environment."
  value       = module.container_environment.static_ip_address
}

output "container_app_environment_outbound_ip_addresses" {
  description = "Dev environment-level outbound addresses; later slices union these with workload outputs before firewall reconciliation."
  value       = module.container_environment.outbound_ip_addresses
}

output "runtime_identity" {
  description = "Root-owned dev runtime workload identity metadata."
  value = {
...
output "migrator_identity" {
  description = "Root-owned dev migration workload identity metadata; it holds no vault role."
  value = {
