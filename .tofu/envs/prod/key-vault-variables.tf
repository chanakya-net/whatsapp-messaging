variable "tenant_id" {
  description = "Azure tenant containing the prod resources."
  type        = string
...
variable "subscription_id" {
  description = "Azure subscription containing the prod resources."
  type        = string
...
variable "bootstrap_serial" {
  description = "Three-digit suffix matching the bootstrap-owned prod resource group."
  type        = string
...
variable "repository" {
  description = "Repository responsible for the prod resources."
  type        = string
...
variable "runtime_identity" {
  description = "Dependency-owned prod runtime identity metadata; this root creates no identity."
  type = object({
    principal_id = string
    resource_id  = string
  })
...
variable "operator_identity" {
  description = "Non-secret metadata for the prod secret operator."
  type = object({
    principal_id   = string
